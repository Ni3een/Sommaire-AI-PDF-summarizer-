      ...
      <div className="container mx-auto flex flex-col gap-4">
        ...
        >
          <div className="flex flex-col gap-4">
            {/* Title skeleton */}
            <MotionDiv
              className="h-10 sm:h-12 bg-gradient-to-r from-rose-100 to-rose-50 rounded-xl w-3/4 max-w-2xl"
              animate={{ opacity: [0.5, 1, 0.5] }}
              transition={{ duration: 1.5, repeat: Infinity }}
            />
            {/* Date skeleton */}
            <MotionDiv
              className="h-5 bg-rose-100/50 rounded-lg w-48"
        ...
        <MotionDiv
          ...
          className="px-4"
        >
          <div className="flex flex-wrap gap-4 items-center bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-rose-100/30">
            <MotionDiv
              className="h-6 bg-rose-100/60 rounded-lg w-32"
              animate={{ opacity: [0.5, 1, 0.5] }}
              transition={{ duration: 1.5, repeat: Infinity }}
            />
            <MotionDiv
              className="h-6 bg-rose-100/40 rounded-lg w-24"
              animate={{ opacity: [0.4, 0.8, 0.4] }}
